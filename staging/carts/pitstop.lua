...
function init()
    ...
    snd.reserve_channel(3) -- reserved for tyre screech
...
function load_map(track_num)
    ...
    while true do
        local ms = {}
        ms[1] = TRACKS[track_num][start]
        ms[2] = TRACKS[track_num][start + 1]
        ms[3] = TRACKS[track_num][start + 2]
        if newfmt then
            ms[4] = TRACKS[track_num][start + 3]
            ms[5] = TRACKS[track_num][start + 4]
            ms[6] = TRACKS[track_num][start + 5]
            ms[7] = TRACKS[track_num][start + 6]
        end
        if ms[1] == 0 then
            break
        end
